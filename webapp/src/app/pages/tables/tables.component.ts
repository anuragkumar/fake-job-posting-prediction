...
export class TablesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.createMyChart('telecommuting', 'telecommuteChart', 'darkRed', 'bar', false);
    this.createMyChart('has_company_logo', 'companyLogoChart', 'darkOrange', 'bar', false);
    this.createMyChart('has_questions', 'hasQuestionsChart', 'lightGrey', 'bar', false);
  }
  ...
  createMyChart = (content, canvasName, chartColor, chartType='bar', flag=false) => {
    ...
    this.dataService.getOrigBarPlotData({plotName: content, boolean: flag}).subscribe(res => {
      console.log(res);
